...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Tambah Data Guru / Pegawai</h3>
    </div>
    <div class="card-body">
        ...
        <form action="<?= base_url('data-guru/store') ?>" method="post">
            <?= csrf_field() ?>
            ...
            <div class="row row-cards">
                <div class="col-md-6 col-xl-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_pegawai" placeholder="Masukkan nama..." value="<?= old('nama_pegawai') ?>" required>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4">
                    <div class="mb-3">
                        <label class="form-label">NIP</label>
                        <input type="text" class="form-control" name="nip" placeholder="Masukkan NIP jika ada" value="<?= old('nip') ?>">
                    </div>
                </div>
                <div class="col-md-6 col-xl-4">
                    <div class="mb-3">
                        <label class="form-label">PEG ID / NUPTK</label>
                        <input type="text" class="form-control" name="peg_id_nuptk" placeholder="Masukkan PEG ID / NUPTK" value="<?= old('peg_id_nuptk') ?>">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="tempat_lahir" placeholder="Contoh: Jakarta" value="<?= old('tempat_lahir') ?>">
                    </div>
                </div>
                <div class="col-md-6 col-xl-4">
                    <div class="mb-3">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="jabatan_mengajar" placeholder="Contoh: Guru Kelas / Kepala Sekolah" value="<?= old('jabatan_mengajar') ?>">
                    </div>
                </div>
                <div class="col-md-6 col-xl-4">
                    <div class="mb-3">
                        <label class="form-label">Pangkat Golongan</label>
                        <input type="text" class="form-control" name="pangkat_golongan" placeholder="Contoh: Pembina Tk. I, IV/b" value="<?= old('pangkat_golongan') ?>">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="pendidikan_terakhir" placeholder="Contoh: S1 / S2" value="<?= old('pendidikan_terakhir') ?>">
                    </div>
                </div>
                <div class="col-md-6 col-xl-6">
                    <div class="mb-3">
                        <label class="form-label">Perguruan Tinggi</label>
                        <input type="text" class="form-control" name="perguruan_tinggi" placeholder="Nama kampus lulusan" value="<?= old('perguruan_tinggi') ?>">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="mulai_tugas" id="mulai_tugas" value="<?= old('mulai_tugas') ?>">
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="mb-3">
                        <label class="form-label">TMT CPNS / Honorer</label>
                        <input type="date" class="form-control" name="tmt_cpns_honorer" id="tmt_cpns_honorer" value="<?= old('tmt_cpns_honorer') ?>">
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="mb-3">
                        <label class="form-label">Masa Kerja (di MIN)</label>
                        <input type="text" class="form-control" name="masa_kerja_min" id="masa_kerja_min" placeholder="Terisi otomatis..." value="<?= old('masa_kerja_min') ?>" readonly>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="mb-3">
                        <label class="form-label">Masa Kerja PNS</label>
                        <input type="text" class="form-control" name="masa_kerja_pns" id="masa_kerja_pns" placeholder="Terisi otomatis..." value="<?= old('masa_kerja_pns') ?>" readonly>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="kenaikan_pangkat" placeholder="Contoh: 01 April 2022" value="<?= old('kenaikan_pangkat') ?>">
                    </div>
                </div>
                <div class="col-md-6 col-xl-4">
                    <div class="mb-3">
                        ...
                        <select name="status_kepegawaian" class="form-select">
                            ...
                            <option value="Honorer" <?= old('status_kepegawaian') == 'Honorer' ? 'selected' : '' ?>>Honorer / Non PNS</option>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" name="email" placeholder="email@example.com" value="<?= old('email') ?>">
                    </div>
                </div>
                <div class="col-md-6 col-xl-4">
                    <div class="mb-3">
                        <label class="form-label">Nomor HP</label>
                        <input type="text" class="form-control" name="no_handphone" placeholder="08xxxxxxxxxx" value="<?= old('no_handphone') ?>">
                    </div>
                </div>
            ...
            <div class="form-footer text-end mt-4">
                <button type="submit" class="btn btn-primary">
                    <i class="ti ti-device-floppy icon me-2"></i> Simpan Data Guru
                </button>
            </div>
        </form>
    </div>
